...
public class ProductoController {
    ...
    private final IUnidadService ums;
    ...
    public void initialize(){
      /*  Platform.runLater(() -> {
        ...
        System.out.println(ps.listarTipoProducto().size());
    ...
    public void listar (){
        try {
            ...
            listarProducto= FXCollections.observableArrayList(ps.findDall());
